      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            ...
            ideas. My passion lies in creating unique web app experiences for
            users and utilizing my knowledge of business to successfully
            organize a team and complete tasks in an efficient and manner.
          </p>
